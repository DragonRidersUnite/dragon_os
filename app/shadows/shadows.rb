class Shadows < Game
  ...
  def calc_action_history
    ...
    state.curr_space     = inputs.keyboard.key_down.z        ||
  ...
  def calc_light_crystal
    ...
    if player.hurt_rect.intersect_rect? light_rect
      state.jitter_fade_out_render_queue << { x:    state.light_crystal.x,
                                              ...
                                              a:    255,
                                              path: 'app/shadows/sprites/light.png' }
  ...
  def calc_game_over
    ...
    if state.game_over
      ...
      state.game_over_render_queue << state.light_crystal.merge(a: 255, path: 'app/shadows/sprites/light.png', b: 128)
    end
  end
  ...
  def render_stage
    ...
    outputs.sprites << { x: 0,
                         ...
                         w: 1280,
                         h: 720,
                         path: "app/shadows/sprites/stage.png",
                         a: 200 }
  end
  ...
  def render_light_meter
    ...
    outputs.sprites << { x: 0,
                         ...
                         source_h: 128,
                         h: 64,
                         path: 'app/shadows/sprites/meter-light.png' }
    ...
    outputs.sprites << { x: 1280 * meter_perc,
                         ...
                         source_h: 128,
                         h: 64,
                         path: 'app/shadows/sprites/meter-dark.png' }
  end
  ...
  def render_light_meter_warning
    ...
    outputs.primitives << { x: state.light_crystal.x - 32,
                            ...
                            h: 128,
                            a: 255 - state.light_meter,
                            path: 'app/shadows/sprites/spotlight.png' }
  end
  ...
  def render_entity entity, r: 255, g: 255, b: 255;
    ...
    if entity.action == :standing
      path = "app/shadows/sprites/player/stand.png"
      ...
      path = "app/shadows/sprites/player/run-#{sprint_index}.png"
      ...
      sprint_index = entity.action_at
                           .frame_index count: 2,
                                        ...
                                        repeat: false,
                                        tick_count_override: entity.clock
      path = "app/shadows/sprites/player/jump-#{sprint_index || 1}.png"
      ...
      sprint_index = entity.action_at
                           .frame_index count: state.midair_jump_frame_count,
                                        ...
                                        repeat: false,
                                        tick_count_override: entity.clock
      path = "app/shadows/sprites/player/midair-jump-#{sprint_index || 8}.png"
    elsif entity.action == :falling
      path = "app/shadows/sprites/player/falling.png"
    end
